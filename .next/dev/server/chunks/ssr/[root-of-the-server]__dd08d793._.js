...
"[project]/bLOG WEBSITE/pages/posts/[slug].tsx [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getStaticPaths = async ()=>{
    const slugs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$bLOG__WEBSITE$2f$lib$2f$posts$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getPostSlugs"])().map((s)=>s.replace(/\.md$/, ''));
    return {
...
const getStaticProps = async ({ params })=>{
    ...
    const { meta, content } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$bLOG__WEBSITE$2f$lib$2f$posts$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getPostBySlug"])(`${slug}.md`);
    return {
        props: {
            meta,
            content
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dd08d793._.js.map